...
rule all:
  input:
    expand("results/IBDne_output/{dataset}_GERMLINE2_2015_IBDNe_minibd-{cM}.log", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2015_IBDNe_minibd-{cM}.pair.excl", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2015_IBDNe_minibd-{cM}.region.excl", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2015_IBDNe_minibd-{cM}.ne", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2015_IBDNe_minibd-{cM}.boot", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2020_IBDNe_minibd-{cM}.log", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2020_IBDNe_minibd-{cM}.pair.excl", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2020_IBDNe_minibd-{cM}.region.excl", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2020_IBDNe_minibd-{cM}.ne", dataset=DATASET, cM=cM),
    expand("results/IBDne_output/{dataset}_GERMLINE2_2020_IBDNe_minibd-{cM}.boot", dataset=DATASET, cM=cM),
...
rule v_2015_ibdne:
  ...
  output:
    multiext("results/IBDne_output/{dataset}_GERMLINE2_2015_IBDNe_minibd-{cM}", ".log", ".pair.excl", ".region.excl", ".ne", ".boot")
  benchmark:
  ...
  shell:
    """
    cat {input.ibd} | java -jar /share/hennlab/progs/IBDne/ibdne.04Sep15.e78.jar map={input.map} out=results/IBDne_output/{wildcards.dataset}_GERMLINE2_IBDNe_minibd-{cM} minibd={cM} nthreads={threads} nboots=80 gmax={GMAX}
    """
...
rule v_2020_ibdne:
  input:
    ...
    map = "prepare/all_chroms/{dataset}.allchr.phased.cm.map"
  output:
    multiext("results/IBDne_output/{dataset}_GERMLINE2_2020_IBDNe_minibd-{cM}", ".log", ".pair.excl", ".region.excl", ".ne", ".boot")
  benchmark:
    "benchmarks/{dataset}/{cM}_ibdne.txt"
  threads:
    IBDne_THREADs
